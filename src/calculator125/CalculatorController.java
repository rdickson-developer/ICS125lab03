...
public class CalculatorController {
	...
	public CalculatorController(CalculatorView theView
		...
		this.theView.addCalculateListener(new CalculateListener());
                this.theView.addProductListenter(new ProductListener());
	}
	...
	class CalculateListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
                    ...
                    int firstNumberMult = 0;
                    int secondNumberMult = 0;
                    ...
                    try {
                        ...
                        theView.setProductSolution(theModel.getCalculationValue());			
                    }
                    catch (NumberFormatException ex) {
			// Provide an error message to the console output.	
                        System.out.println(ex);				
